...
function RelatedCard({ item }: { item: Pick<BookingNewsItem, "Id_news" | "Title" | "Slug" | "Thumbnail"> }) {
  return (
    <Link
    ...
    <main className="bg-white">
      <article className="mx-auto max-w-[1604px] px-4 py-7 sm:px-6 sm:py-10 lg:px-6">
        <div className="text-sm text-gray-500">
          ...
          <Link href="/tintuc" className="hover:text-[#33B1FA]">
            Nụ cười dịch vụ
          </Link>
          <span className="mx-2">/</span>
          ...
          <div className="space-y-4 lg:col-span-8">
            ...
            <div className="mt-6 rounded-3xl border border-gray-100 bg-gray-50 p-6">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Cập nhật thêm các bài viết mới nhất tại trang Nụ cười dịch vụ của 25Zone.
              </p>
